...
# Paths to pre-trained model components (adjust if needed)
...
class NepWearHD:
    ...
    def _tokenize_caption(self, caption: str, max_length: int = 3):
        inputs = self.tokenizer(caption, max_length=max_length, padding="max_length", truncation=True, return_tensors="pt")
